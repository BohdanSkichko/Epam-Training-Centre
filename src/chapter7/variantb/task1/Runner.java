...
public class Runner {
    public static void main(String[] args) {
        Text text = new Text();
        text.parseText("The \"standard\"  error output stream. This  stream is already open and ready to accept output data.\n" +
...
//        System.out.println(text.findCountSentenceWithRepeatedWords());
//        System.out.println(text.increaseSentenceLenght());
        System.out.println(text.UniqueWord());
    }
}
